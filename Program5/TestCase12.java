...
public class TestCase12
{
	...
	{
		System.out.println("Test Case #12: hasConstrainedTopoSort(" + params + "): fail whale :(");
		System.exit(0);
	}
	...
	public static void main(String [] args) throws IOException
	{
		...
		if (t.hasConstrainedTopoSort(4, 1) != false) failwhale("1, 3");
		if (t.hasConstrainedTopoSort(4, 7) != true) failwhale("1, 5");
		if (t.hasConstrainedTopoSort(4, 5) != false) failwhale("4, 5");

		System.out.println("Test Case #12: PASS (Hooray!)");
	}
}
